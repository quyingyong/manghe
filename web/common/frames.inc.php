		...
		'section' => array(
			'store_goods' => array(
				...
				'menu' => array(
					'store_goods_module' => array(
						'title' => '应用模块',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1, 'type' => 'module')),
						'icon' => 'wi wi-apply',
						'type' => 'module',
					),
					'store_goods_account' => array(
						'title' => '平台个数',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1, 'type' => 'account_num')),
						'icon' => 'wi wi-account',
						'type' => 'account_num',
					),
					'store_goods_account_renew' => array(
						'title' => '平台续费',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1,  'type' => 'renew')),
						'icon' => 'wi wi-appjurisdiction',
						'type' => 'renew',
					),
					'store_goods_package' => array(
						'title' => '应用权限组',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1,  'type' => STORE_TYPE_PACKAGE)),
						'icon' => 'wi wi-appjurisdiction',
						'type' => STORE_TYPE_PACKAGE,
					),
					'store_goods_user_account' => array(
						'title' => '账号权限组',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1,  'type' => STORE_TYPE_ACCOUNT_PACKAGE)),
						'icon' => 'wi wi-appjurisdiction',
						'type' => STORE_TYPE_ACCOUNT_PACKAGE,
					),
					'store_goods_user_renew' => array(
						'title' => '账号有效期',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1,  'type' => STORE_TYPE_USER_RENEW)),
						'icon' => 'wi wi-appjurisdiction',
						'type' => STORE_TYPE_USER_RENEW,
					),
					'store_goods_users_package' => array(
						'title' => '用户权限组',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1, 'type' => STORE_TYPE_USER_PACKAGE)),
						'icon' => 'wi wi-userjurisdiction',
						'type' => STORE_TYPE_USER_PACKAGE,
					),
					'store_goods_api' => array(
						'title' => '应用访问流量(API)',
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1,  'type' => STORE_TYPE_API)),
						'icon' => 'wi wi-api',
						'type' => STORE_TYPE_API,
					),
				),
			...
			'store_wish_goods' => array(
				...
				'menu' => array(
					'store_wish_goods_list' => array(
						'title' => '应用列表',
						'founder' => false,
						'url' => url('site/entry/goodsbuyer', array('module_name' => 'store', 'direct' => 1, 'type' => 'module_wish', 'is_wish' => 1)),
						'icon' => 'wi wi-apply',
						'type' => 'module_wish',
					),
					'store_wish_goods_edit' => array(
						'title' => '添加/设置应用',
						'founder' => true,
						'url' => url('site/entry/wishgoodsEdit', array('module_name' => 'store', 'direct' => 1, 'op' => 'wishgoods', 'status' => 1)),
			...
			'store_manage' => array(
				...
				'menu' => array(
					'store_manage_goods' => array(
						'title' => '添加商品',
						'url' => url('site/entry/goodsSeller', array('module_name' => 'store', 'direct' => 1)),
						'icon' => 'wi wi-goods-add',
						'type' => 'goodsSeller',
					),
					'store_manage_setting' => array(
						'title' => '商城设置',
						'url' => url('site/entry/setting', array('module_name' => 'store', 'direct' => 1)),
						'icon' => 'wi wi-store',
						'type' => 'setting',
					),
					'store_manage_payset' => array(
						'title' => '支付设置',
						'url' => url('site/entry/paySetting', array('module_name' => 'store', 'direct' => 1)),
						'icon' => 'wi wi-money',
						'type' => 'paySetting',
					),
					'store_manage_permission' => array(
						'title' => '商城访问权限',
						'url' => url('site/entry/permission', array('module_name' => 'store', 'direct' => 1)),
			...
			'store_orders' => array(
				...
				'menu' => array(
					'store_orders_my' => array(
						'title' => '我的订单',
						'url' => url('site/entry/orders', array('module_name' => 'store', 'direct' => 1)),
					...
					'store_cash_orders' => array(
						'title' => '分销订单',
						'vice_founder' => true,
						'url' => url('site/entry/cash', array('module_name' => 'store', 'operate' => 'cash_orders', 'direct' => 1)),
						'icon' => 'wi wi-order',
						'type' => 'cash_orders',
					),
				),
			...
			'store_payments' => array(
				...
				'menu' => array(
					'payments' => array(
						'title' => '收入明细',
						'url' => url('site/entry/payments', array('module_name' => 'store', 'direct' => 1)),
						'icon' => 'wi wi-sale-record',
						'type' => 'payments',
					),
				),
			...
			'store_cash_manage' => array(
				...
				'menu' => array(
					'store_manage_cash_setting' => array(
						'title' => '分销设置',
						'url' => url('site/entry/cashsetting', array('module_name' => 'store', 'direct' => 1)),
						'icon' => 'wi wi-site-setting',
						'type' => 'cashsetting',
					),
					'store_check_cash' => array(
						'title' => '提现审核',
						'url' => url('site/entry/cash', array('module_name' => 'store', 'operate' => 'consume_order', 'direct' => 1)),
			...
			'store_cash' => array(
				...
				'menu' => array(
					'payments' => array(
						'title' => '我的佣金',
						'url' => url('site/entry/cash', array('module_name' => 'store', 'operate' => 'mycash', 'direct' => 1)),
						'icon' => 'wi wi-list',
						'type' => 'mycash',
					),
				),
