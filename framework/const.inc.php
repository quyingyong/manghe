...
!defined('CLOUD_API_DOMAIN') && define('CLOUD_API_DOMAIN', 'http://127.0.0.1');
...
define('STORE_TYPE_MODULE', 1); define('STORE_TYPE_WXAPP_MODULE', 4); define('STORE_TYPE_WEBAPP_MODULE', 11); define('STORE_TYPE_PHONEAPP_MODULE', 12); define('STORE_TYPE_ALIAPP_MODULE', 14); define('STORE_TYPE_BAIDUAPP_MODULE', 15); define('STORE_TYPE_TOUTIAOAPP_MODULE', 16); 
...
define('WXAPP_REGISTER_CHECK_STATUS_FAIL', 3); define('WXAPP_REGISTER_VERSION_STATUS_DEVELOP', 0); define('WXAPP_REGISTER_VERSION_STATUS_CHECKFAIL', 1); define('WXAPP_REGISTER_VERSION_STATUS_CHECKING', 2); define('WXAPP_REGISTER_VERSION_STATUS_RETRACT', 3); define('WXAPP_REGISTER_VERSION_STATUS_RELEASE', 4); define('WXAPP_REGISTER_VERSION_STATUS_CHECKSUCCESS', 5); 